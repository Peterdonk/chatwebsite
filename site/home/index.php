...
if ($_SESSION['token']) {
    ...
    if ($result) {
        if (mysqli_num_rows($result) > 0) {
            $_SESSION['msg'] = "Choose Option";
            $_SESSION['msgBg'] = "info";
            $_SESSION['msgTxt'] = "white";
        } else {
            $_SESSION['msg'] = "Your Account Is Not exists";
...
<body>
    ...
    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
        <div class="p-lg-5 mx-auto my-5">
            <h3 class="text-muted mb-2">Welcome <u><?php echo $_SESSION['username']; ?></u></h3>
            <h1 class="font-weight-normal">Wispy Chat Room</h1>
            <p class="lead font-weight-normal">Chat With Your Friend Free.</p>
            <form action="../createroom/" method="POST">
                <button class="btn btn-outline-secondary my-3" href="">Claim Room</button>
            </form>
            <form action="../joinroom/" method="POST">
                <button class="btn btn-outline-secondary my-3" href="">Join Room</button>
            </form>
        </div>
    ...
    <form action="../searchpeople/" method="POST" class="form-group friendDiv">
        <h5 class="text-muted mr-3">Search User: </h5>
        <input name="friendName" class="form-control friendName" placeholder="Enter Username" style="width: 30%;" required="">
        <button class="btn btn-outline-secondary mx-3" href="">Search</button>
    </form>
