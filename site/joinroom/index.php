...
<body>
    ...
    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
        <div class="p-lg-5 mx-auto my-5">
            ...
            <form action="join.php" method="POST">
                <input type="text" class="mx-2 inp" name="joinroom">
    ...
    <ul class="list-group">
        <li class="list-group-item text-center active">TOP PUBLIC ROOMS</li>
        <?php
        $sql = "SELECT * FROM `rooms2` WHERE `type`='public' LIMIT 5";
        $result = mysqli_query($conn, $sql);
        while ($row = mysqli_fetch_assoc($result)) {
            if (mysqli_num_rows($result) > 10) {
                while (mysqli_num_rows($result) > 10) {
                    echo '
                        <li class="list-group-item text-center room">' . $row['roomname'] . '</li>
                    ';
                }
            } else {
                echo '
